...
class ButtonPicker: UIButton {
  ...
  var pickerConfiguration: ImagePicker.Configuration = .init()
  ...
  public init(pickerConfiguration: ImagePicker.Configuration? = nil) {
    if let pickerConfiguration = pickerConfiguration {
