...
class MapleFlexibleHeaderContainerViewController: MDCFlexibleHeaderContainerViewController {
    ...
    init() {
        ...
        let collectionVC = ProductController(collectionViewLayout: layout)
