//
//  UserPostSettingsController.swift
//  maple
//
//  Created by Murray Toews on 2017-07-30.
...
enum EditPostSettings: String {
    case Cancel = "Cancel"
    case Settings = "Edit"
    case TermsPrivacy = "Delete"
}


class UserPostSettingsController: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
