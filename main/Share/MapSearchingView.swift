...
//
//  Created by Brian Voong on 12/6/19.
...
struct MapViewContainer: UIViewRepresentable {
    ...
    // tokyo 35.753630, 139.714151
    
    var currentLocation = CLLocationCoordinate2D(latitude: 35.753630, longitude: 139.714151)
...
public struct MapSearchingView: View {
    ...
    public var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 12) {
                HStack {
                    TextField("Search ...", text: $vm.searchQuery, onCommit: {
